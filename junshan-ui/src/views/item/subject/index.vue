  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="课程类型" prop="subjectType">
        <el-select v-model="queryParams.subjectType" placeholder="请选择课程类型" clearable size="small">
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['item:subject:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['item:subject:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="subjectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程类型" align="center" prop="subjectType" :formatter="subjectTypeFormat" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="课程类型" prop="subjectType">
          <el-select v-model="form.subjectType" placeholder="请选择课程类型">
            <el-option
              v-for="dict in subjectTypeOptions"
              :key="dict.dictValue"
              :label="dict.dictLabel"
...
<script>
import { listSubject, getSubject, delSubject, addSubject, updateSubject, exportSubject } from "@/api/item/subject";
