...
const state = {
  ...
  exam: {
    ...
    question: {
      ...
      editUrlEnum: [{ key: 1, value: '/item/question/edit/singleChoice', name: '单选题' },
        { key: 2, value: '/item/question/edit/multipleChoice', name: '多选题' },
        { key: 3, value: '/item/question/edit/trueFalse', name: '判断题' },
        { key: 4, value: '/item/question/edit/gapFilling', name: '填空题' },
        { key: 5, value: '/item/question/edit/shortAnswer', name: '简答题' }]
    }
  }
}
